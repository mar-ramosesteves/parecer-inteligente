...
def build_organizational_feedback_prompt(pacote):
    return (
        ...
        "para a gestao e qual pergunta executiva ele abre. "
        ...
        "- resumo_executivo: objeto com sintese, tensao_central, sinais_fortes, pontos_de_atencao, leitura_para_ceo e perguntas_estrategicas.\n"
