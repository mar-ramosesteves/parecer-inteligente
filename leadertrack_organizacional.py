...
def build_organizational_feedback_prompt(pacote):
    return (
        ...
        "carga de trabalho, turnover, desempenho financeiro, eventos passados ou cruzamentos. "
        ...
        "Evite recomendacoes comoditizadas como team building, feedback regular, treinamento generico ou comunicacao interna "
        ...
        "- Prefira 4 a 6 achados robustos por secao quando houver dados suficientes.\n"
